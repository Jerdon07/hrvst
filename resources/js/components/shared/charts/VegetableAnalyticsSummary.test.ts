...
function analytics(
    overrides: Partial<VarietyAnalytics> = {},
): VarietyAnalytics {
    return {
...
describe('VegetableAnalyticsSummary', () => {
    ...
    describe('fulfillment rate coloring — three-tier thresholds at 0.7 and 0.5', () => {
        it('is green at and above 0.7', () => {
            const wrapper = mount(VegetableAnalyticsSummary, {
                props: {
                    analytics: analytics({ supply_fulfillment_rate: 0.7 }),
                },
            })
        ...
        it('is amber in the [0.5, 0.7) band', () => {
            const wrapper = mount(VegetableAnalyticsSummary, {
                props: {
                    analytics: analytics({ supply_fulfillment_rate: 0.5 }),
                },
            })
        ...
        it('is red below 0.5', () => {
            const wrapper = mount(VegetableAnalyticsSummary, {
                props: {
                    analytics: analytics({ supply_fulfillment_rate: 0.49 }),
                },
            })
        ...
        it('renders a muted em-dash instead of a percentage when the rate is null', () => {
            const wrapper = mount(VegetableAnalyticsSummary, {
                props: {
                    analytics: analytics({ demand_fulfillment_rate: null }),
                },
            })
        ...
        it('rounds the percentage rather than truncating', () => {
            const wrapper = mount(VegetableAnalyticsSummary, {
                props: {
                    analytics: analytics({ supply_fulfillment_rate: 0.666 }),
                },
            })
